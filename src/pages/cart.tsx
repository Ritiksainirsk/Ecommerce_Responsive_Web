  ...
  return (
    <div className="w-full md:my-20">
      <Wrapper>
        ...
        <Image src={"/empty-cart.jpg"} alt={"..."} width={300} height={300}/>
        <span className="text-xl font-bold">Your card is empty</span>
        <Link href={"/"} className="bg-black py-3 text-white mt-4 px-10 rounded-full active:scale-95 hover:bg-black/[0.9]">
          Continue Shopping
        </Link>
        </div> */}
